# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-12-04 14:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resources.Idc')),
            ],
        ),
        migrations.CreateModel(
            name='HostGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('values', models.CharField(max_length=128, unique=True)),
                ('expire', models.IntegerField(default=1800, verbose_name='超时时间(s)')),
                ('date', models.DateTimeField(auto_now_add=True)),
